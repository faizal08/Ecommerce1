$(document).ready(function () {
    ...
    $('#address-tab').on('click', function (e) {
        ...
        $.ajax({
            url: '/glamgaze/address', // Your controller endpoint to fetch address content
            method: 'GET',
    ...
    $('#orders-tab').on('click', function (e) {
        ...
        // Load address content using AJAX
        $.ajax({
            url: '/glamgaze/orders', // Your controller endpoint to fetch address content
            method: 'GET',
            success: function (data) {
                // Update the content of the target tab
    ...
    $('#account-detail-tab').on('click', function (e) {
        ...
        // Load address content using AJAX
        $.ajax({
            url: '/glamgaze/account-details', // Your controller endpoint to fetch account content
            method: 'GET',
            success: function (data) {
                // Update the content of the target tab
